...
from nutri.core.profile.dto import CollectionDTO, PersonalRecipeDTO, RewardsDTO, AchievementDTO
...
async def get_user_rewards(
    ...
    from nutri.core.profile.dto import RewardsDTO, AchievementDTO
    ...
    inv_result = await db.execute(
        select(func.count(func.distinct(UserInventory.ingredient_id)))
    ...
    achievements = [
        AchievementDTO(id="pantryMaster", points="+50", unlocked=pantry_unlocked),
        AchievementDTO(id="consistentPlanner", points="+100", unlocked=planner_unlocked),
    ]
